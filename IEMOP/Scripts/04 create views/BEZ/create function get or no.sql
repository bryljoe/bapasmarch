create or replace function get_or_no_bez(p_site_code in varchar2)
  return number as
...
begin
    ...
    begin
      select seq.seq_no, seq.last_3_digit
        ...
        from cs.pop_sites_tin@dalag.aboitiz.net tin,
             cs.pop_sites_seq@dalag.aboitiz.net seq
    ...
    if l_or_no > 0 then
      update cs.pop_sites_seq@dalag.aboitiz.net
         set seq_no = seq_no + 1
       where last_3_digit = l_last_3_digit;

      insert into cs.used_or_numbers@dalag.aboitiz.net
