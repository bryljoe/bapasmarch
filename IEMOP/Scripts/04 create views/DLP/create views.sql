...
select batch_no,
       ...
       requested_lt_min,
       granted_lt_min
  from cs.collection_batches@duhol.aboitiz.net;
/
...
select tran_no,
       ...
       cancel_reason,
       or_count
  from cs.payment_transactions@duhol.aboitiz.net;
