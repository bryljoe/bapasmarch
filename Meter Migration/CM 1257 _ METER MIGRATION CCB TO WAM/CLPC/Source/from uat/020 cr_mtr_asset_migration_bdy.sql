create or replace package body cr_mtr_asset_migration_pkg is
  /* ============================================================
  ...
  begin
    select count(1)
      into l_record_cnt
      from synergen.sa_asset@wamprod.apd.com.ph
     where plant = p_plant
       and asset_type = '1I01'
  ...
  begin
    if p_action = 'I' then
      ...
      if not has_asset_id(p_plant => p_plant, p_badge_nbr => p_badge_nbr) then
        ...
        l_errline := 30;
        insert into synergen.sa_asset@wamprod.apd.com.ph
          (plant,
           attribute3,
        ...
        l_errline := 40;
        update synergen.sa_asset@wamprod.apd.com.ph
  ...
  begin
    ...
    if p_action = 'I' then
      ...
      update synergen.sa_component_id@wamprod.apd.com.ph
